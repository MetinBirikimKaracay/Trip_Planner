...
import kotlinx.android.synthetic.main.activity_yildiz_park.*
import kotlinx.android.synthetic.main.activity_yildiz_park.comment
import kotlinx.android.synthetic.main.activity_yildiz_park.mainLayout
import kotlinx.android.synthetic.main.activity_yildiz_park.spParkPuan
import kotlinx.android.synthetic.main.activity_yildiz_park.yorumEkle

class YildizPark : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_yildiz_park)
        ...
        if(totalPoint == 0){
            ratingBarYildiz.rating = 3F
        }else if (totalPoint > 0){
            var rate = totalPoint / counter
            ratingBarYildiz.rating = rate.toFloat()
        }

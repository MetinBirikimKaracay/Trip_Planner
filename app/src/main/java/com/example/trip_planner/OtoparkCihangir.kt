...
import kotlinx.android.synthetic.main.activity_otopark_cihangir.*
import kotlinx.android.synthetic.main.activity_otopark_cihangir.spOtoparkPuan
import kotlinx.android.synthetic.main.activity_otopark_cihangir.comment
import kotlinx.android.synthetic.main.activity_otopark_cihangir.mainLayout
import kotlinx.android.synthetic.main.activity_otopark_cihangir.yorumEkle

class OtoparkCihangir : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_otopark_cihangir)
        ...
        //Başlık ekle
        actionBar!!.title = "Otopark Cihangir"
        ...
        if(totalPoint == 0)
        {
            ratingBarOtoparkCihangir.rating = 3F
        }
        else if(totalPoint > 0)
        {
            var rate = totalPoint / counter
            //ratingbarın idsini düzelt
            ratingBarOtoparkCihangir.rating = rate.toFloat()
        }

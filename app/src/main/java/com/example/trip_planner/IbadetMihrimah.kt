...
import kotlinx.android.synthetic.main.activity_ibadet_mihrimah.*
import kotlinx.android.synthetic.main.activity_ibadet_mihrimah.spIbadetPuan
import kotlinx.android.synthetic.main.activity_ibadet_mihrimah.comment
import kotlinx.android.synthetic.main.activity_ibadet_mihrimah.mainLayout
import kotlinx.android.synthetic.main.activity_ibadet_mihrimah.yorumEkle

class IbadetMihrimah : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ibadet_mihrimah)
        ...
        //Başlık ekle
        actionBar!!.title = "Mihrimah Sultan Camii"
        ...
        if(totalPoint == 0)
        {
            ratingBarIbadetMihrimah.rating = 3F
        }
        else if(totalPoint > 0)
        {
            var rate = totalPoint / counter
            //ratingbarın idsini düzelt
            ratingBarIbadetMihrimah.rating = rate.toFloat()
        }

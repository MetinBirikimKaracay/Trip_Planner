...
import kotlinx.android.synthetic.main.activity_topkapi_park.comment
import kotlinx.android.synthetic.main.activity_topkapi_park.mainLayout
import kotlinx.android.synthetic.main.activity_topkapi_park.spParkPuan
import kotlinx.android.synthetic.main.activity_topkapi_park.yorumEkle

class TopkapiPark : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_topkapi_park)
        ...
        if(totalPoint == 0){
            ratingBarTopkapi.rating = 3F
        }else if (totalPoint > 0){
            var rate = totalPoint / counter
            ratingBarTopkapi.rating = rate.toFloat()
        }

...
import kotlinx.android.synthetic.main.activity_kbeyazit.*
import kotlinx.android.synthetic.main.activity_kbeyazit.comment
import kotlinx.android.synthetic.main.activity_kbeyazit.mainLayout
import kotlinx.android.synthetic.main.activity_kbeyazit.yorumEkle

class KBeyazit : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kbeyazit)
        ...
        //Başlık ekle
        actionBar!!.title = "Beyazıt Kütüphanesi"

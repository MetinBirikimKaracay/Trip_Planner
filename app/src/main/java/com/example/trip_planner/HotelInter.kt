...
//import kotlinx.android.synthetic.main.activity_tyayasofya.*
//import kotlinx.android.synthetic.main.activity_tyayasofya.ratingBarTYAyasofya

class HotelInter : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hotel_inter)
        ...
        //Başlık ekle
        actionBar!!.title = "Intercontinental Hotel"

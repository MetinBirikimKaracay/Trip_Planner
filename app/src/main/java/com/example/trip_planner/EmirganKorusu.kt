...
import kotlinx.android.synthetic.main.activity_emirgan_korusu.*
import kotlinx.android.synthetic.main.activity_emirgan_korusu.comment
import kotlinx.android.synthetic.main.activity_emirgan_korusu.mainLayout
import kotlinx.android.synthetic.main.activity_emirgan_korusu.spParkPuan
import kotlinx.android.synthetic.main.activity_emirgan_korusu.yorumEkle

class EmirganKorusu : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_emirgan_korusu)
        ...
        actionBar!!.title = "Emirgan Korusu"
        ...
        if(totalPoint == 0){
            ratingBarEmirgan.rating = 3F
        }else if (totalPoint > 0){
            var rate = totalPoint / counter
            ratingBarEmirgan.rating = rate.toFloat()
        }

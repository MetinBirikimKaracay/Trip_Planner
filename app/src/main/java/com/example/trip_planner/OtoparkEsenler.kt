...
import kotlinx.android.synthetic.main.activity_otopark_esenler.*
import kotlinx.android.synthetic.main.activity_otopark_esenler.spOtoparkPuan
import kotlinx.android.synthetic.main.activity_otopark_esenler.comment
import kotlinx.android.synthetic.main.activity_otopark_esenler.mainLayout
import kotlinx.android.synthetic.main.activity_otopark_esenler.yorumEkle

class OtoparkEsenler : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_otopark_esenler)
        ...
        //Başlık ekle
        actionBar!!.title = "Otopark Esenler"
        ...
        if(totalPoint == 0)
        {
            ratingBarOtoparkEsenler.rating = 3F
        }
        else if(totalPoint > 0)
        {
            var rate = totalPoint / counter
            //ratingbarın idsini düzelt
            ratingBarOtoparkEsenler.rating = rate.toFloat()
        }

...
import kotlinx.android.synthetic.main.activity_ibadet_yusa.*

class IbadetYusa : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ibadet_yusa)
        ...
        //Başlık ekle
        actionBar!!.title = "Hz.Yuşa Türbesi"

...
import kotlinx.android.synthetic.main.activity_tytopkapi.*
import kotlinx.android.synthetic.main.activity_tytopkapi.comment
import kotlinx.android.synthetic.main.activity_tytopkapi.mainLayout
import kotlinx.android.synthetic.main.activity_tytopkapi.yorumEkle


class TYTopkapi : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tytopkapi)
        ...
        //Başlık ekle
        actionBar!!.title = "Topkapı Sarayı"

...
import kotlinx.android.synthetic.main.activity_kataturk.*

class KAtaturk : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kataturk)
        ...
        //Başlık ekle
        actionBar!!.title = "Atatürk Kütüphanesi"

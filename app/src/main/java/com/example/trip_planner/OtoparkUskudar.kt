...
import kotlinx.android.synthetic.main.activity_otopark_uskudar.*
import kotlinx.android.synthetic.main.activity_otopark_uskudar.spOtoparkPuan
import kotlinx.android.synthetic.main.activity_otopark_uskudar.comment
import kotlinx.android.synthetic.main.activity_otopark_uskudar.mainLayout
import kotlinx.android.synthetic.main.activity_otopark_uskudar.yorumEkle

class OtoparkUskudar : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_otopark_uskudar)
        ...
        //Başlık ekle
        actionBar!!.title = "Otopark Üsküdar"
        ...
        if(totalPoint == 0)
        {
            ratingBarOtoparkUskudar.rating = 3F
        }
        else if(totalPoint > 0)
        {
            var rate = totalPoint / counter
            //ratingbarın idsini düzelt
            ratingBarOtoparkUskudar.rating = rate.toFloat()
        }

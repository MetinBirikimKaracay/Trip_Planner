...
import kotlinx.android.synthetic.main.activity_tygalata.*

class TYGalata : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tygalata)

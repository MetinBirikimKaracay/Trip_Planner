...
import kotlinx.android.synthetic.main.activity_tyayasofya.comment
import kotlinx.android.synthetic.main.activity_tyayasofya.mainLayout
import kotlinx.android.synthetic.main.activity_tyayasofya.yorumEkle


class TYAyasofya : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tyayasofya)

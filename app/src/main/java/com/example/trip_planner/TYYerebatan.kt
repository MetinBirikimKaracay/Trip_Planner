...
import kotlinx.android.synthetic.main.activity_tyyerebatan.*
import kotlinx.android.synthetic.main.activity_tyyerebatan.comment
import kotlinx.android.synthetic.main.activity_tyyerebatan.mainLayout
import kotlinx.android.synthetic.main.activity_tyyerebatan.yorumEkle

class TYYerebatan : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tyyerebatan)
        ...
        //Başlık ekle
        actionBar!!.title = "Yerebatan Sarnıcı"

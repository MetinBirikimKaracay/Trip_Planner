...
import kotlinx.android.synthetic.main.activity_tysultan_ahmet.*
import kotlinx.android.synthetic.main.activity_tysultan_ahmet.comment
import kotlinx.android.synthetic.main.activity_tysultan_ahmet.mainLayout
import kotlinx.android.synthetic.main.activity_tysultan_ahmet.yorumEkle

class TYSultanAhmet : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tysultan_ahmet)
        ...
        //Başlık ekle
        actionBar!!.title = "Sultan Ahmet Camii"

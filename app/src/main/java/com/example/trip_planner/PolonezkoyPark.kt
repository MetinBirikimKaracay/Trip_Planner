...
//Burdakileri mekana özel olarak değiştirmek zorundasın
...
import kotlinx.android.synthetic.main.activity_polonezkoy_park.spParkPuan
import kotlinx.android.synthetic.main.activity_polonezkoy_park.yorumEkle


class PolonezkoyPark : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        //burayı activitye bağla
        setContentView(R.layout.activity_polonezkoy_park)
        ...
        //Başlık ekle
        actionBar!!.title = "Polonezköy Tabiat Parkı"
        ...
        ratingBarPolonezkoy.rating = rate.toFloat()

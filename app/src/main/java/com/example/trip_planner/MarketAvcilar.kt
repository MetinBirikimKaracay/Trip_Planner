...
import kotlinx.android.synthetic.main.activity_market_avcilar.*
import kotlinx.android.synthetic.main.activity_market_avcilar.ratingBarMarketAvcilar
import kotlinx.android.synthetic.main.activity_market_avcilar.comment
import kotlinx.android.synthetic.main.activity_market_avcilar.mainLayout
import kotlinx.android.synthetic.main.activity_market_avcilar.yorumEkle

class MarketAvcilar : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_market_avcilar)
        ...
        //Başlık ekle
        actionBar!!.title = "Carrefour SA Avcılar"

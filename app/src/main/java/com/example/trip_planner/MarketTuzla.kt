...
import kotlinx.android.synthetic.main.activity_market_tuzla.*

class MarketTuzla : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_market_tuzla)

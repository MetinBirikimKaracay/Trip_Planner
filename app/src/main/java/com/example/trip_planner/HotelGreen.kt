...
import kotlinx.android.synthetic.main.activity_hotel_green.*
import kotlinx.android.synthetic.main.activity_hotel_green.comment
import kotlinx.android.synthetic.main.activity_hotel_green.mainLayout
import kotlinx.android.synthetic.main.activity_hotel_green.yorumEkle
import kotlinx.android.synthetic.main.activity_login.*

class HotelGreen : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hotel_green)
        ...
        //Başlık ekle
        actionBar!!.title = "The Green Park Hotel"
        //Sol üstte geri git ikonu oluşturur
        actionBar.setDisplayHomeAsUpEnabled(true)

        // Verilen Puanı Tuttuğumuz Değişken
        var SelectedPoint:String = ""
        var adi:String = girisKullaniciAdi.toString()
        var soyadi:String = girisSoyadi.toString()

...
import kotlinx.android.synthetic.main.activity_hotel_crowne.*
import kotlinx.android.synthetic.main.activity_hotel_crowne.comment
import kotlinx.android.synthetic.main.activity_hotel_crowne.mainLayout
import kotlinx.android.synthetic.main.activity_hotel_crowne.yorumEkle
import kotlinx.android.synthetic.main.activity_login.*

class HotelCrowne : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hotel_crowne)

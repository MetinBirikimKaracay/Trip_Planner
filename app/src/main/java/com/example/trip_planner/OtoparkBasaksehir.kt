...
import kotlinx.android.synthetic.main.activity_otopark_basaksehir.*
import kotlinx.android.synthetic.main.activity_otopark_basaksehir.spOtoparkPuan
import kotlinx.android.synthetic.main.activity_otopark_basaksehir.comment
import kotlinx.android.synthetic.main.activity_otopark_basaksehir.mainLayout
import kotlinx.android.synthetic.main.activity_otopark_basaksehir.yorumEkle

class OtoparkBasaksehir : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_otopark_basaksehir)
        ...
        //Başlık ekle
        actionBar!!.title = "Otopark Bahçeşehir"

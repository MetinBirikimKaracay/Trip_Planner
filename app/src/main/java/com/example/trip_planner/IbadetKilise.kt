...
import kotlinx.android.synthetic.main.activity_ibadet_kilise.*
import kotlinx.android.synthetic.main.activity_ibadet_kilise.spIbadetPuan
import kotlinx.android.synthetic.main.activity_ibadet_kilise.comment
import kotlinx.android.synthetic.main.activity_ibadet_kilise.mainLayout
import kotlinx.android.synthetic.main.activity_ibadet_kilise.yorumEkle
import kotlinx.android.synthetic.main.activity_login.*

class IbadetKilise : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ibadet_kilise)
        ...
        //Başlık ekle
        actionBar!!.title = "St. Antuan Kilisesi"
        ...
        if(totalPoint == 0)
        {
            ratingBarIbadetKilise.rating = 3F
        }
        else if(totalPoint > 0)
        {
            var rate = totalPoint / counter
            //ratingbarın idsini düzelt
            ratingBarIbadetKilise.rating = rate.toFloat()
        }

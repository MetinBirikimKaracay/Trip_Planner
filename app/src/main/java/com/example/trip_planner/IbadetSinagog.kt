...
import kotlinx.android.synthetic.main.activity_ibadet_sinagog.*
import kotlinx.android.synthetic.main.activity_ibadet_sinagog.spIbadetPuan
import kotlinx.android.synthetic.main.activity_ibadet_sinagog.comment
import kotlinx.android.synthetic.main.activity_ibadet_sinagog.mainLayout
import kotlinx.android.synthetic.main.activity_ibadet_sinagog.yorumEkle

class IbadetSinagog : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ibadet_sinagog)
        ...
        //Başlık ekle
        actionBar!!.title = "Bet Israel Sinagogu"
        ...
        if(totalPoint == 0)
        {
            ratingBarIbadetSinagog.rating = 3F
        }
        else if(totalPoint > 0)
        {
            var rate = totalPoint / counter
            //ratingbarın idsini düzelt
            ratingBarIbadetSinagog.rating = rate.toFloat()
        }

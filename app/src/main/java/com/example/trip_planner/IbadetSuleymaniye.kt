...
import kotlinx.android.synthetic.main.activity_ibadet_suleymaniye.*
import kotlinx.android.synthetic.main.activity_ibadet_suleymaniye.spIbadetPuan
import kotlinx.android.synthetic.main.activity_ibadet_suleymaniye.comment
import kotlinx.android.synthetic.main.activity_ibadet_suleymaniye.mainLayout
import kotlinx.android.synthetic.main.activity_ibadet_suleymaniye.yorumEkle
import kotlinx.android.synthetic.main.activity_login.*

class IbadetSuleymaniye : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ibadet_suleymaniye)
        ...
        //Başlık ekle
        actionBar!!.title = "Süleymaniye Camii"
        ...
        if(totalPoint == 0)
        {
            ratingBarIbadetSüleyman.rating = 3F
        }
        else if(totalPoint > 0)
        {
            var rate = totalPoint / counter
            //ratingbarın idsini düzelt
            ratingBarIbadetSüleyman.rating = rate.toFloat()
        }

...
import kotlinx.android.synthetic.main.activity_kersoy.*
import kotlinx.android.synthetic.main.activity_kersoy.comment
import kotlinx.android.synthetic.main.activity_kersoy.mainLayout
import kotlinx.android.synthetic.main.activity_kersoy.yorumEkle

class KErsoy : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kersoy)
        ...
        //Başlık ekle
        actionBar!!.title = "Mehmet Akif Ersoy Kütüphanesi"

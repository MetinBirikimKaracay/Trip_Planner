...
import kotlinx.android.synthetic.main.activity_goztepe_park.*
import kotlinx.android.synthetic.main.activity_goztepe_park.comment
import kotlinx.android.synthetic.main.activity_goztepe_park.mainLayout
import kotlinx.android.synthetic.main.activity_goztepe_park.spParkPuan
import kotlinx.android.synthetic.main.activity_goztepe_park.yorumEkle
import kotlinx.android.synthetic.main.activity_login.*
import kotlinx.android.synthetic.main.activity_sign_in.*

class GoztepePark : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_goztepe_park)
        ...
        actionBar!!.title = "Göztepe 60.Yıl Parkı"
        ...
        if(totalPoint == 0){
            ratingBarGoztepePark.rating = 3F
        }else if (totalPoint > 0){
            var rate = totalPoint / counter
            ratingBarGoztepePark.rating = rate.toFloat()
        }

...
import kotlinx.android.synthetic.main.activity_market_sariyer.spMarketPuan
import kotlinx.android.synthetic.main.activity_market_sariyer.*
import kotlinx.android.synthetic.main.activity_market_sariyer.comment
import kotlinx.android.synthetic.main.activity_market_sariyer.mainLayout
import kotlinx.android.synthetic.main.activity_market_sariyer.yorumEkle

class MarketSariyer : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_market_sariyer)
        ...
        //Başlık ekle
        actionBar!!.title = "Migros Sarıyer"
        ...
        if(totalPoint == 0)
        {
            ratingBarMarketSariyer.rating = 3F
        }
        else if(totalPoint > 0)
        {
            var rate = totalPoint / counter
            //ratingbarın idsini düzelt
            ratingBarMarketSariyer.rating = rate.toFloat()
        }

...
import kotlinx.android.synthetic.main.activity_kturabi_baba.*
import kotlinx.android.synthetic.main.activity_kturabi_baba.comment
import kotlinx.android.synthetic.main.activity_kturabi_baba.mainLayout
import kotlinx.android.synthetic.main.activity_kturabi_baba.yorumEkle

class KTurabiBaba : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kturabi_baba)
        ...
        //Başlık ekle
        actionBar!!.title = "Turabi Baba Kütüphanesi"

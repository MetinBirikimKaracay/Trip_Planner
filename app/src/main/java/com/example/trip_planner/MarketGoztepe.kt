...
import kotlinx.android.synthetic.main.activity_market_goztepe.*
import kotlinx.android.synthetic.main.activity_market_goztepe.spMarketPuan
import kotlinx.android.synthetic.main.activity_market_goztepe.comment
import kotlinx.android.synthetic.main.activity_market_goztepe.mainLayout
import kotlinx.android.synthetic.main.activity_market_goztepe.yorumEkle

class MarketGoztepe : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_market_goztepe)
        ...
        if(totalPoint == 0)
        {
            ratingBarMarketGoztepe.rating = 3F
        }
        else if(totalPoint > 0)
        {
            var rate = totalPoint / counter
            //ratingbarın idsini düzelt
            ratingBarMarketGoztepe.rating = rate.toFloat()
        }
